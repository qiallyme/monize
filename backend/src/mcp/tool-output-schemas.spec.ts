...
const cases: Array<{ name: string; schema: RawShape; raw: unknown }> = [
  ...
  {
    name: "updateTransactionOutput (updated branch)",
    schema: schemas.updateTransactionOutput,
    raw: {
      id: "t1",
      date: "2026-02-01",
      amount: -30,
  ...
  {
    name: "updateTransactionOutput (dry-run branch)",
    schema: schemas.updateTransactionOutput,
    raw: {
      dryRun: true,
      preview: {
  ...
  {
    name: "deleteTransactionOutput (deleted branch)",
    schema: schemas.deleteTransactionOutput,
    raw: { id: "t1", deleted: true },
  },
  {
    name: "deleteTransactionOutput (dry-run branch)",
    schema: schemas.deleteTransactionOutput,
    raw: {
      dryRun: true,
      preview: {
